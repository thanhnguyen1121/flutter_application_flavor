...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/ic_fries_menu.svg
  SvgGenImage get icFriesMenu =>
      const SvgGenImage('assets/icons/ic_fries_menu.svg');
  ...
  /// File path: assets/icons/ic_notification_note.svg
  SvgGenImage get icNotificationNote =>
      const SvgGenImage('assets/icons/ic_notification_note.svg');

  /// List of all assets
  List<SvgGenImage> get values =>
      [homeBlack24dp, icFriesMenu, icNotification, icNotificationNote];
}
...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [icLogoSplash, iconApp, roundHomeBlack24dp];
}
